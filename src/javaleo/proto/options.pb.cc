...
const char descriptor_table_protodef_options_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\roptions.proto\022\rjavaleo.proto\032 google/p"
  "rotobuf/descriptor.proto:1\n\010javatype\022\035.g"
  "oogle.protobuf.FieldOptions\030\242\220\003 \001(\tb\006pro"
  "to3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_options_2eproto = {
  &descriptor_table_options_2eproto_initialized, descriptor_table_protodef_options_2eproto, "options.proto", 123,
